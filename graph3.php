...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         ...
         title: {
            text: 'Grafik Rata-Rata Pencapaian Kinerja Pegawai Ka.Subag TU'
         },
         xAxis: {
            categories: ['Bulan']
         },
...
$sql   = "SELECT AVG(nilai) from pencapaian where Year(pencapaian.tanggal)='$thn' and 
						penilai='$_GET[id]' order by tanggal ASC"; // file untuk mengakses ke tabel database
...
while($ambil = mysql_fetch_array($query)){
	...
	$sql_jumlah   = "SELECT * from pencapaian where Year(pencapaian.tanggal)='$thn' and 
						 penilai='$_GET[id]' order by tanggal ASC";        
